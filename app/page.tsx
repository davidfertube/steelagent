...
import { ArrowRight, Menu, X, Sun, Moon, CheckCircle, Shield, Microscope, ClipboardCheck, Package, Scale } from "lucide-react";
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-neutral-950 text-black dark:text-white">
      ...
      <main className="flex-1 pt-16">
        ...
        <section id="why" className="relative min-h-screen flex items-center py-12 sm:py-16 md:py-20">
          <div className="container-center">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <section id="who" className="relative py-12 sm:py-16 md:py-20 scroll-mt-16">
          <div className="container-center">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="container-center">
          <div className="flex justify-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-black/60 dark:text-white/60 text-sm ml-1">
                by Antigravity
              </span>
            </div>
          </div>
