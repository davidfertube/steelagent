...
export function Logo({ size = 32, className }: LogoProps) {
  return (
    ...
    >
      ...
      <polygon points="32,5 53.5,18.5 53.5,45.5 32,59 10.5,45.5 10.5,18.5" fill="#1e293b" stroke="#22c55e" strokeWidth="1.5" />
      {/* Steel I-beam cross section (horizontal) */}
      ...
      {/* Subtle inner glow lines on I-beam */}
      ...
      {/* Corner accent marks (engineering/technical feel) */}
